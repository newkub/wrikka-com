...
การทำให้เว็บไซต์เร็วขึ้นเป็นสิ่งสำคัญที่ส่งผลต่อ user experience และ SEO วันนี้มาดูเทคนิคต่างๆ ในการเพิ่มประสทธิภาพ Nuxt 3 กัน
...
```vue [composables/usePerformance.ts]
<script setup>
// ใช้ performance API
onMounted(() => {
...
## 9. ตารางสรุปเทคนิค (Table)

| Technique          | When to use        | Impact           |
| ------------------ | ------------------ | ---------------- |
| Image optimization | รูปใหญ่/เยอะ         | ลด LCP/เพิ่มความคม |
| Lazy loading       | UI หนัก/เฉพาะบางหน้า | ลด initial JS    |
| Caching            | ข้อมูลซ้ำๆ            | ลด latency       |
| Prefetch           | เส้นทางที่คนไปต่อบ่อย   | ลดเวลา navigate  |
