...
<template>
	<div class="flex flex-col gap-2rem">
		<div class="text-center py-2rem">
			<h1 class="text-3rem font-700 mb-0.5rem md:text-2.5rem text-gray-900 dark:text-gray-100">
				Get in Touch
			</h1>
		...
		<div class="max-w-2xl mx-auto px-1.5rem w-full">
			<div>
				<div
					v-if="submitSuccess"
					class="bg-green-100 dark:bg-green-900 border border-green-200 dark:border-green-800 rounded-0.5rem p-2rem text-center"
				>
					<Icon
						name="mdi:check-circle"
						class="w-4rem h-4rem text-green-600 dark:text-green-400 mx-auto mb-1rem"
					/>
					<h2 class="text-1.75rem font-700 mb-0.5rem text-gray-900 dark:text-gray-100">
						Message Sent!
					</h2>
				...
				<form
					...
					class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-0.5rem p-2rem shadow-sm"
				>
					<div
						v-if="submitError"
						class="bg-red-100 dark:bg-red-900 border border-red-200 dark:border-red-800 rounded-0.5rem p-1rem mb-1rem"
					>
					...
					<div class="flex flex-col gap-1.25rem">
						<div>
							<label
								for="name"
								class="block text-0.875rem font-600 text-gray-900 dark:text-gray-100 mb-0.5rem"
							>Name</label>
							<Input
								id="name"
								v-model="form.name"
						...
						<div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-0.375rem p-1rem mb-1rem">
							<p class="text-0.875rem text-gray-600 dark:text-gray-400 m-0">
								...
								Your message will be sent to <span
									class="font-600 text-blue-600 dark:text-blue-400"
