	...
	<div class="flex flex-col gap-2rem">
		<div class="text-center py-2rem">
			...
			<p class="text-1.125rem text-muted-foreground max-w-2xl mx-auto">
				Have a question, want to work together, or just want to say hi? Drop me a message!
			</p>
		</div>
				...
				<div class="space-y-1.5rem">
					...
					<div class="bg-surface border border-border rounded-0.5rem p-2rem shadow-sm">
						<h2 class="text-1.25rem font-600 mb-1rem text-foreground flex items-center gap-0.5rem">
							<Icon name="mdi:account-circle" class="w-1.25rem h-1.25rem text-primary" />
							Connect with Me
						</h2>
						<div class="flex gap-1rem flex-wrap">
							...
							>
								<Icon :name="link.icon" class="w-1.25rem h-1.25rem" :class="link.color" />
					...
					<div class="bg-surface border border-border rounded-0.5rem p-2rem shadow-sm">
						<h2 class="text-1.25rem font-600 mb-1rem text-foreground flex items-center gap-0.5rem">
							<Icon name="mdi:information" class="w-1.25rem h-1.25rem text-primary" />
							Contact Information
						</h2>
						<div class="space-y-1rem">
							<div class="flex items-start gap-0.75rem">
								<Icon name="mdi:email" class="w-1.25rem h-1.25rem text-primary mt-0.125rem" />
								<div>
							...
							<div class="flex items-start gap-0.75rem">
								<Icon name="mdi:clock" class="w-1.25rem h-1.25rem text-primary mt-0.125rem" />
								<div>
									<p class="text-0.875rem font-600 text-foreground">Response Time</p>
					...
					<div class="bg-primary/5 border border-primary/20 rounded-0.5rem p-2rem">
						<h2 class="text-1.25rem font-600 mb-1rem text-foreground flex items-center gap-0.5rem">
							<Icon name="mdi:lightbulb" class="w-1.25rem h-1.25rem text-primary" />
							Quick Tip
						</h2>
						<p class="text-0.875rem text-muted-foreground">
							For faster response, please include details about your project or question in the message.
						</p>
					</div>
				</div>
					...
					<div class="flex flex-col gap-1.5rem">
						...
						<div class="space-y-0.5rem">
							<label
								...
								class="block text-0.875rem font-600 text-foreground flex items-center gap-0.375rem"
							>
								<Icon name="mdi:format-title" class="w-1rem h-1rem text-primary" />
								Subject
							</label>
							<Input
								id="subject"
						...
						<div class="space-y-0.5rem">
							<label
								...
								class="block text-0.875rem font-600 text-foreground flex items-center gap-0.375rem"
							>
								<Icon name="mdi:message-text" class="w-1rem h-1rem text-primary" />
								Message
							</label>
							<textarea
								id="message"
						...
						<div class="bg-primary/5 border border-primary/20 rounded-0.5rem p-1rem flex items-start gap-0.75rem">
							<Icon name="mdi:information-outline" class="w-1.25rem h-1.25rem text-primary mt-0.125rem flex-shrink-0" />
							<p class="text-0.875rem text-muted-foreground m-0">
								Your message will be sent to <span class="font-600 text-primary">mewkubise@gmail.com</span>
							</p>
						</div>
