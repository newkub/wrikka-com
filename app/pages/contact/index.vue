				...
				>
					...
					<div class="flex flex-col gap-1.25rem">
						<div>
							<label
								for="name"
								class="block text-0.875rem font-600 text-foreground mb-0.5rem"
							>Name</label>
							<Input
								id="name"
								v-model="form.name"
						...
						<div>
							...
							<textarea
								...
								required
								rows="6"
								class="w-full px-1rem py-0.75rem bg-surface border border-border rounded-0.375rem text-foreground focus:outline-none focus:ring-2 focus:ring-primary transition-all-0.2s resize-y"
							></textarea>
						</div>
