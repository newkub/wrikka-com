...
export const useSEO = (data: SEOData) => {
  ...
  const defaultDescription = 'Personal portfolio and blog of a full-stack developer specializing in Vue.js, Nuxt, and modern web technologies.';
  ...
  const keywords = data.keywords?.join(', ') || 'web development, vue.js, nuxt, javascript, typescript, portfolio, blog';
