...
export const useCaseStudies = () => {
	const caseStudies = ref<CaseStudy[]>([
		{
			...
			problem: "The existing e-commerce platform had outdated UI/UX, slow performance, and poor mobile experience, leading to low conversion rates.",
			solution: "Redesigned the entire platform using modern technologies, implemented responsive design, optimized performance, and improved user experience.",
		...
		},
		{
			...
			solution: "Created a dashboard that aggregates data from multiple sources and displays it in real-time with customizable widgets.",
		...
		},
		{
			...
			solution: "Built a unified platform that allows scheduling, analytics, and management of multiple social media accounts from one place.",
			outcome: "Saved 10+ hours per week on social media management, increased engagement by 35%, and improved content consistency.",
	...
	const featuredCaseStudies = computed(() =>
		caseStudies.value.filter(cs => cs.featured)
	);
